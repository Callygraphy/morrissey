...
module Morrissey
  # Morrissey::ShowExceptions catches all exceptions raised from the app it
  ...
  class ShowExceptions < Rack::ShowExceptions
    ...
    def frame_class(frame)
      if frame.filename =~ /lib\/morrissey.*\.rb/
        "framework"
...
<body>
  <div id="wrap">
    <div id="header">
      <img src="<%= env['SCRIPT_NAME'] %>/__morrissey__/500.gif" alt="application error" height="161" width="313" />
      <div id="summary">
        <h1>And what a terrible mess I've made of my life</h1>
        <h2><strong><%=h exception.class %></strong> at <strong><%=h path %>
          </strong></h2>
